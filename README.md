...
Context  
An app is created to include a workflow from lab 4 and also to add other tools using Langchain. These tools include using a file system to save responses from the workflow, using Wikipedia to immprove web search and using Python REPL for debugging.  
